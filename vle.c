...
//  { "name"       , op        , mask                    , type   ,   op_type           , COND_AL, {TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG, TYPE_REG}}
  ...
  // has cr0-cr3  
  { "e_bgectr"   , 0x7A000000, 0x7A200000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_GE, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_blectr"   , 0x7A000000, 0x7A210000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_LE, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bnectr"   , 0x7A000000, 0x7A220000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_NE, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bnsctr"   , 0x7A000000, 0x7A230000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_VC, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bltctr"   , 0x7A000000, 0x7A310000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_LT, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bgtctr"   , 0x7A000000, 0x7A320000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_GT, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_beqctr"   , 0x7A000000, 0x7A330000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_EQ, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bsoctr"   , 0x7A000000, 0x7A340000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_VS, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bcctr"    , 0x7A000000, 0x7A340000 | E_MASK_BD15, E_BD15 ,  OP_TYPE_CJMP, COND_VS, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bgectrl"  , 0x7A000001, 0x7A200001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_GE, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_blectrl"  , 0x7A000001, 0x7A210001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_LE, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bnectrl"  , 0x7A000001, 0x7A220001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_NE, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bnsctrl"  , 0x7A000001, 0x7A230001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_VC, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bltctrl"  , 0x7A000001, 0x7A310001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_LT, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bgtctrl"  , 0x7A000001, 0x7A320001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_GT, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_beqctrl"  , 0x7A000001, 0x7A330001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_EQ, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bsoctrl"  , 0x7A000001, 0x7A340001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_VS, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
  { "e_bcctrl"   , 0x7A000001, 0x7A340001 | E_MASK_BD15, E_BD15 , OP_TYPE_CCALL, COND_VS, {TYPE_CR, TYPE_JMP, TYPE_NONE, TYPE_NONE, TYPE_NONE}},
